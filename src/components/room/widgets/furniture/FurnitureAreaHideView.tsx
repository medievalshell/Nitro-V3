                ...
                <Column gap={1}>
                    ...
                    <Flex gap={1}>
                        <input
                            ...
                            id="setWallItems"
                            checked={wallItems}
                            onChange={(event) => setWallItems(event.target.checked ? true : false)}
                        />
                    ...
                    <Flex gap={1}>
                        <input
                            ...
                            id="setInverted"
                            checked={inverted}
                            onChange={(event) => setInverted(event.target.checked ? true : false)}
                        />
                        <Column gap={1}>
                    ...
                    <Flex gap={1}>
                        <input
                            ...
                            onChange={(event) => setInvisibility(event.target.checked ? true : false)}
                        />
                        <Column gap={1}>
