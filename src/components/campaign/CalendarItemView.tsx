        ...
        >
                    ...
                    <Flex center className="campaign-spritesheet campaign-opened">
                        {product && (
                            <LayoutImage
                                imageUrl={
                                    product.customImage
                                        ? GetConfigurationValue<string>('image.library.url') + product.customImage
                                        : getFurnitureIcon(product.productName)
                                }
                            />
                        )}
                    </Flex>
            ...
            {state !== CalendarItemState.STATE_UNLOCKED && (
                <Flex center className="campaign-spritesheet locked-bg">
                    {state === CalendarItemState.STATE_LOCKED_AVAILABLE && <div className="campaign-spritesheet available" />}
