    ...
    return (
        <Grid style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="flex items-center center justify-between">
                ...
                <Text onClick={() => GetUserProfile(Number(getUserData(currentImage.s, Number(currentImage.u), 'id')))}>
                    {' '}
                    {getUserData(currentImage.s, Number(currentImage.u), 'username')}{' '}
                </Text>
                <Text className="cursor-pointer" onClick={() => GetUserProfile(currentImage.oi)}>
                    {currentImage.o}
                </Text>
